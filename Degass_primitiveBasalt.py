...
filename = 'Poas_PrimitiveBasalt_model'
save_plots = True
...
###############user settings
sample = "poas_primitive_basalt"
modeltype = 3
lowP = 500 #for model types 2 and 3, in bars
dQFMvalue = 0 #for model types 2 and 3, need to know fO2 pegged to QFM buffer
	...
	for i in H2Orange:
		for j in CO2range:
			for k in Srange:
				...
				if sample == "poas_primitive_basalt":
					...
					MeltComposition_deep_wt = 	{	"SiO2": 47.40, #POAS sample Po170425R3-gls9 from Monse
													"TiO2": 0.05,
													"Al2O3": 31.95,
													"FeOstar": 1.06, #EITHER put FeOstar or separate FeO and Fe2O3, NOT BOTH! 
													"Fe2O3": 0,
													"FeO": 0,
													"MnO": 0.01,
													"MgO": 0.11,
					...
					MeltComposition_shallow_wt = 	{	"SiO2": 47.40, #POAS sample Po170425R3-gls9 from Monse
														"TiO2": 0.05,
														"Al2O3": 31.95,
														"FeOstar": 1.06, #EITHER put FeOstar or separate FeO and Fe2O3, NOT BOTH! 
														"Fe2O3": 0,
